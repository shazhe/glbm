...
spplot(grace_sp, "mmweqt", at = seq(-21, 21, 2))
...
plot(grace_loc$area ~ grace_area, xlim = c(0, 3e5), ylim = c(0, 3e5))
abline(a = 0, b = 1)
...
grace_sp$pred_mean2 <- ifelse(abs(grace_sp$pred_mean) > 20, sign(grace_sp$pred_mean)*20, grace_sp$pred_mean )
spplot(grace_sp, "pred_mean2", at = seq(-21, 21, 2))
