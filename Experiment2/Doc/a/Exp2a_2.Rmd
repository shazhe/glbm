...
mu_r <- 2500/6371
v_r <- 1
mu_s <- 10/10 # area scale to about 100km^2 ~ 1 degree resolution
v_s <- 5^2
...
lattice::levelplot(mean ~ lon + lat, data = M_pred, aspect = "iso", 
                     ...
                     main = "The predicited unadjusted mass change", xlab = "longitude", ylab = "latitude")
...
lattice::levelplot(u ~ lon + lat, data = M_pred, aspect = "iso", 
                     ...
                     main = "The predicted uncertainties", xlab = "longitude", ylab = "latitude")
...
ice6g$trendm <- ice6g$trend/gia_area*1e4 # scale to have about the same area as the mesh triangles
GIA_v <- ice6g$trendm[mesh_idx]
...
spplot(grace_sp, "gia2", main = "GIA aggreated on the GRACE grid (mm/yr ewh)")
