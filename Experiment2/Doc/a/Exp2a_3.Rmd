...
u2 <- ifelse(steric_u > 3, 3.5, steric_u)
...
lattice::levelplot(u2 ~ lon + lat, data = steric_data, aspect = "iso", at = seq(0, 4, 0.5), col.regions = topo.colors(10), 
                     panel = function(x,y,z,...){
                       lattice::panel.fill(col = "grey")
                       lattice::panel.levelplot(x,y,z,...)
                       map2 <- map("world2", interior = FALSE, plot = FALSE)
...
steric_plot$err <- ifelse(steric_plot$err > 3, 3.5, steric_plot$err)
...
lattice::levelplot(err ~ lon + lat|model, data = steric_plot, aspect = "iso", at = seq(0, 4, 0.5), col.regions = topo.colors(10),
                     panel = function(x,y,z,...){
                       lattice::panel.fill(col = "grey")
                       lattice::panel.levelplot(x,y,z,...)
                       map2 <- map("world2", interior = FALSE, plot = FALSE)
