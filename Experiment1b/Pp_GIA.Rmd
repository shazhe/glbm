...
# mesh_sub <- mesh
# mesh_sub$t <- length(Omega[[i]]) # number of triangles
# sub_nodes <- unique(as.vector(mesh_sub$graph$tt[Omega[[i]], ])) # vertices index of all triangles
# mesh_sub$n <- length(sub_nodes) # number of verticies
