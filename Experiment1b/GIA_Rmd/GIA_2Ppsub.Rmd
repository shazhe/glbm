...
We have first used a [***global stationary model***]() and now we try to deal with the non-stationary of the process comes from experts' opinion that at some regions the GIA should be zero in theroy for sure. Three different approaches are used in modelling the non-stationarity:
