---
title: "Estimating GIA -- 2 Pseudo polygon with polygon observations"
author: "Z Sha"
...
## set up prior and build the SPDE 
...
if(Sys.info()["sysname"] == "Windows"){
  load("Z:/WP1-BHM/Experiment1b/GIA_RGL/res3.RData")
}else if(grep("Ubuntu",Sys.info()["version"]) == 1){
 load("~/GMdata/GIA_RGL/res3.RData")
}
INLA_pred <- res_inla$summary.linear.predictor
```
